---
title: "[KO] New Forrester study shows customers who unified with Microsoft Security benefited from 124% ROI"
date: 2026-06-18 19:36:08 +0000
categories: ["Agent 365"]
tags: ["microsoft agent 365"]
solution: agent-365
owners: ["akimcse"]
source_url: "https://www.microsoft.com/en-us/security/blog/2026/06/18/new-forrester-study-shows-customers-who-unified-with-microsoft-security-benefited-from-124-roi/"
source_author: "Vasu Jakkal"
auto_generated: true
pin: false
---
> 본 글은 Microsoft Security Blog의 [New Forrester study shows customers who unified with Microsoft Security benefited from 124% ROI](https://www.microsoft.com/en-us/security/blog/2026/06/18/new-forrester-study-shows-customers-who-unified-with-microsoft-security-benefited-from-124-roi/) 글을 한국어로 번역·정리한 것입니다. 원문 작성자: Vasu Jakkal.
{: .prompt-info }
...
[Read the full Forrester TEI study](https://aka.ms/E2ETEIReport)
...
- Up to 30% reduction in the likelihood of a breachIntegrated protection across identities, endpoints, data, and infrastructure helps prevent attacks before they succeed.

- Up to 25% reduction in cost to remediate remaining attacksEnd-to-end visibility and coordinated response cut the cost of incidents that do occur.

- Up to 23% reduced annual technology spendConsolidating point solutions eliminates redundant tooling and the licensing and services that come with it.

- Up to 32% avoided headcount growthAutomation, integration, and self-service let teams scale without scaling proportionally.

- 20% lower total cost of ownership—$3.0M in TCO savingsA unified platform reduces the operating drag of running disconnected tools.
...
[Read the full Forrester TEI study](https://aka.ms/E2ETEIReport) for a complete methodology, assumptions, and detailed financial analysis.
...
- Security for AI – New solutions like [Microsoft Agent 365](https://www.microsoft.com/en-us/microsoft-agent-365) with foundations of Microsoft Security, extend identity, governance, and control to AI agents, so customers can adopt them with confidence. 

- AI for Security – [Microsoft Security Copilot](https://www.microsoft.com/en-us/security/business/ai-machine-learning/microsoft-security-copilot), together with Microsoft Defender, Entra and Purview provides AI-assisted insights to help defenders investigate, prioritize, and respond to security incidents.

- Security foundations for [Zero Trust](https://www.microsoft.com/en-us/security/business/zero-trust) – Identity and access controls work consistently across the environment, without stitching together multiple vendors. 
...
The era of agentic AI doesn’t just raise the stakes for security. It changes what security should be. Alongside our customers and our partners, we’re building the future of security. Read the full [Forrester Total Economic Impact™ of Microsoft Security study](https://aka.ms/E2ETEIReport). Explore end-to-end [Security for AI](https://www.microsoft.com/en-us/security/business/solutions/security-for-ai) to learn how to safeguard your AI platforms, apps, and agents with comprehensive solutions.

[Read the Forrester TEI study](https://aka.ms/E2ETEIReport)
...
1[Cyber Pulse: An AI Security Report.](https://www.microsoft.com/en-us/security/security-insider/emerging-trends/cyber-pulse-ai-security-report) Microsoft Security Insider.

2Gartner Identifies the Top Cybersecurity Trends for 2025,” March 3, 2025. [https://www.gartner.com/en/newsroom/press-releases/2025-03-03-gartner-identifiesthe-top-cybersecuri…](https://www.gartner.com/en/newsroom/press-releases/2025-03-03-gartner-identifiesthe-top-cybersecurity-trends-for-2025)

The post [New Forrester study shows customers who unified with Microsoft Security benefited from 124% ROI](https://www.microsoft.com/en-us/security/blog/2026/06/18/new-forrester-study-shows-customers-who-unified-with-microsoft-security-benefited-from-124-roi/) appeared first on [Microsoft Security Blog](https://www.microsoft.com/en-us/security/blog).
